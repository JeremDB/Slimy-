...
niveaux_boss = [Levels([Decors(0, 700, 80, 380, 'terre'),Decors(1840, 700, 80, 380, 'terre'),Decors(80, 660, 500, 480, 'terre'),Decors(480, 760, 400, 340, 'terre'),Decors(880, 780, 900, 320, 'terre'),Decors(640, 560, 160, 20, 'terre'),Decors(800, 680, 80, 100, 'terre'),Decors(800, 560, 160, 20, 'terre'),Decors(880, 440, 160, 20, 'terre'),Decors(1040, 320, 240, 20, 'terre'),Decors(1040, 560, 160, 20, 'terre')	])]
...
Decors(80, 660, 500, 480, 'terre'),
Decors(480, 760, 400, 340, 'terre'),
Decors(880, 780, 900, 320, 'terre'),
Decors(640, 560, 160, 20, 'terre'),
Decors(800, 680, 80, 100, 'terre'),
Decors(800, 560, 160, 20, 'terre'),
Decors(880, 440, 160, 20, 'terre'),
Decors(1040, 320, 240, 20, 'terre'),
Decors(1040, 560, 160, 20, 'terre')
	])
	]
